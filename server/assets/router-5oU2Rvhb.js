...
const appCss = "/assets/styles-CEBSGoC2.css";
...
function ErrorComponent({ error, reset }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex min-h-screen items-center justify-center bg-background px-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-md text-center", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-2 text-sm text-muted-foreground", children: "Tente novamente ou volte para a página inicial." }),
...
const Route$2 = createRootRouteWithContext()({
  head: () => ({
    meta: [
      ...
      { name: "author", content: "Salão do Pingo" },
      { property: "og:title", content: "Salão do Pingo — Barbearia" },
      { property: "og:description", content: "Cortes clássicos, barba e estilo com tradição e qualidade. Agende seu horário!" },
...
function RootShell({ children }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("html", { lang: "pt-BR", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("body", { style: { fontFamily: "'Inter', sans-serif" }, children: [
      children,
...
const $$splitComponentImporter$1 = () => import("./agendamento-RXIAprk7.js");
const Route$1 = createFileRoute("/agendamento")({
  ...
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Agende seu horário no Salão do Pingo. Escolha data, horário e serviço."
    }]
  })
});
const $$splitComponentImporter = () => import("./index-B3M5SW4k.js");
const Route2 = createFileRoute("/")({
  ...
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Barbearia Salão do Pingo. Cortes clássicos, barba e estilo com tradição e qualidade. Agende seu horário!"
    }]
  })
});
const AgendamentoRoute = Route$1.update({
  id: "/agendamento",
  path: "/agendamento",
